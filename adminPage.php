			...
			<div class="d-flex justify-content-center">
				<form action="" method="post" class="w-50">
					<div class="d-flex justify-content-center">
						<div class="row py-2">
							<div class="col colId">
								<?php inputElement("<i class=\"fas fa-id-badge\"></i>", "ID", "seriesId", setId()); ?>
							</div>

							<div class="col">
								<?php inputElement("<i class=\"fas fa-tags\"></i>", "Categoty ID", "categoryId", ""); ?>
							</div>
					...
					<div class="py-2">
						<?php inputElement("<i class=\"fas fa-film\"></i>", "TV Series Name", "tvSeriesName", ""); ?>
					</div>

					<div class="pt-2">
						<?php inputCategory("<i class=\"fas fa-image\"></i>", "entities/thumbnails/", "thumbnailDirectory", "") ?>
					</div>

					<div class="py-0">
						<?php inputCategory("<i class=\"fas fa-user-tie\"></i>", "Director", "director", "") ?>
					</div>

					<div class="py-0">
						<?php inputCategory("<i class=\"fas fa-user-friends\"></i>", "Actors", "actor", "") ?>
					</div>

					<div class="pb-2">
						<?php inputCategory("<i class=\"fas fa-video\"></i>", "entities/previews/", "previewDirectory", "") ?>
					</div>
					...
					<div class="d-flex justify-content-center">
						...
						<?php buttonElement("btn-delete", "btn btn-dangers", "<i class=\"fas fa-trash-alt\"></i>", "delete", "dat-toggle='tooltip' data-placement='bottom' title='Delete'"); ?>

						<?php buttonElement("btn-next", "btn btn-dangers", "<i class=\"fas fa-arrow-right\"></i>", "next", "dat-toggle='tooltip' data-placement='bottom' title='Insert Video'"); ?>
					</div>
                ...
                <table class="table table-striped table-dark">
                    ...
                    <tbody id="tbody">
                        <?php 
                                ...
                                $total_pages_sql = "SELECT COUNT(*) FROM entities";
                                $resultPage = mysqli_query($conn,$total_pages_sql);
                                $total_rows = mysqli_fetch_array($resultPage)[0];
                                $total_pages = ceil($total_rows / $no_of_records_per_page);

                                $sql = "SELECT * FROM entities LIMIT $offset, $no_of_records_per_page";
                                ...
                                if($res_data){
                                    while($row = mysqli_fetch_assoc($res_data)){?>
                                        ...
                                        <tr>
                                            ...
                                            <td data-id="<?php echo $row['id']; ?>"><?php echo $row['categoryId']; ?></td>
                                            <td data-id="<?php echo $row['id']; ?>"><?php echo $row['name']; ?></td>
                                            <td data-id="<?php echo $row['id']; ?>"><?php echo $row['thumbnail']; ?></td>
                                            <td data-id="<?php echo $row['id']; ?>"><?php echo $row['preview']; ?></td>
